...
export function ModalQRCode({ aberto, tipo, onFechar, modalRef }: ModalQRCodeProps) {
  ...
  return (
    <div
      ref={modalRef}
      id="modal-pagamento"
      className="scroll-mt-24 min-h-[1px]"
    >
      <AnimatePresence>
        {aberto && (
          <motion.div
            ...
            className="w-full max-w-md mx-auto mt-8 bg-brand-black border-4 border-brand-gold shadow-2xl p-6 sm:p-8"
          ...
          >
            <div className="flex justify-between items-start mb-6">
              <h2 id="modal-titulo" className="font-pixel text-sm text-brand-gold">
                {TITULOS[tipo]}
              </h2>
              <button
                type="button"
